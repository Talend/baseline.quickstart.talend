...
echo TUI_CONFIG_amc_app__server_instance_port=${TUI_CONFIG_amc_app__server_instance_port}  | tee -a "./tui_config_mapping.txt"
...
echo TUI_CONFIG_cmdline_s_logging_logstach_port=${TUI_CONFIG_cmdline_s_logging_logstach_port}  | tee -a "./tui_config_mapping.txt"
echo TUI_CONFIG_cmdline_ci_logging_logstach_port=${TUI_CONFIG_cmdline_ci_logging_logstach_port}  | tee -a "./tui_config_mapping.txt"
...
echo TUI_CONFIG_tac_app__server_instance_port=${TUI_CONFIG_tac_app__server_instance_port}  | tee -a "./tui_config_mapping.txt"
...
echo TUI_CONFIG_tac_git_repository_owner=${TUI_CONFIG_tac_git_repository_owner}  | tee -a "./tui_config_mapping.txt"
...
echo TUI_HOSTS_admin_database_schema_service=${TUI_HOSTS_admin_database_schema_service}  | tee -a "./tui_config_mapping.txt"
...
echo TUI_HOSTS_monitoring_database_schema_service=${TUI_HOSTS_monitoring_database_schema_service}  | tee -a "./tui_config_mapping.txt"
