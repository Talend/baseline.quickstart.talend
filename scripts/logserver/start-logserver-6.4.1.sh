#!/bin/bash
source /opt/talend/set-env-6.4.1.sh
...
ES_LOG=/var/talend/6.4.1/logserver/elasticsearch/logs/elasticsearch.log
...
${LOGSTASH_HOME}/bin/logstash -f logstash-talend.conf >> /var/talend/6.4.1/logserver/logstash/logs/logstash.log 2>&1 &
