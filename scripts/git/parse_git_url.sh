...
#declare git_repo=""
#
#parse_git_url https://github.com/EdwardOst/oodle-eost-us-east-2.git git_protocol git_host git_path git_repo
#echo $git_protocol $git_host $git_path $git_repo
#
#parse_git_url https://github.com/topgolf/user1/oodle-eost-us-east-2.git git_protocol git_host git_path git_repo
#echo $git_protocol $git_host $git_path $git_repo
